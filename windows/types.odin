...
PTIMERAPCROUTINE :: #type proc "stdcall" (
	lpArgToCompletionRoutine: LPVOID,
	dwTimerLowValue, dwTimerHighValue: DWORD,
)

TIMERPROC :: #type proc "stdcall" (_: HWND, _: UINT, _: UINT_PTR, _: DWORD)
...
IStreamVtbl :: struct {
	...
	LockRegion:                  proc "stdcall" (
		this: ^IStream,
		libOffset: ULARGE_INTEGER,
		cb: ULARGE_INTEGER,
		dwLockType: DWORD,
	) -> HRESULT,
	UnlockRegion:                proc "stdcall" (
		this: ^IStream,
		libOffset: ULARGE_INTEGER,
		cb: ULARGE_INTEGER,
		dwLockType: DWORD,
...
IMonikerVtbl :: struct {
	...
	CommonPrefixWith:         proc "stdcall" (
		this: ^IMoniker,
		pmkOther: ^IMoniker,
		ppmkPrefix: ^^IMoniker,
	) -> HRESULT,
	RelativePathTo:           proc "stdcall" (
		this: ^IMoniker,
		pmkOther: ^IMoniker,
		ppmkRelPath: ^^IMoniker,
	) -> HRESULT,
	GetDisplayName:           proc "stdcall" (
		this: ^IMoniker,
		pbc: ^IBindCtx,
		pmkToLeft: ^IMoniker,
		ppszDisplayName: ^LPOLESTR,
	) -> HRESULT,
	ParseDisplayName:         proc "stdcall" (
		this: ^IMoniker,
		pbc: ^IBindCtx,
		pmkToLeft: ^IMoniker,
...
IRunningObjectTableVtbl :: struct {
	...
	GetObject:           proc "stdcall" (
		this: ^IRunningObjectTable,
		pmkObjectName: ^IMoniker,
		ppunkObject: ^^IUnknown,
	) -> HRESULT,
	NoteChangeTime:      proc "stdcall" (
		this: ^IRunningObjectTable,
		dwRegister: DWORD,
		pfiletime: ^FILETIME,
	) -> HRESULT,
...
IBindCtxVtbl :: struct {
	...
	GetRunningObjectTable: proc "stdcall" (
		this: ^IBindCtx,
		pprot: ^^IRunningObjectTable,
	) -> HRESULT,
	RegisterObjectParam:   proc "stdcall" (
		this: ^IBindCtx,
		pszKey: LPOLESTR,
		punk: ^IUnknown,
	) -> HRESULT,
	GetObjectParam:        proc "stdcall" (
		this: ^IBindCtx,
		pszKey: LPOLESTR,
		ppunk: ^^IUnknown,
	) -> HRESULT,
...
IShellItemVtbl :: struct {
	...
	GetAttributes:      proc "stdcall" (
		this: ^IShellItem,
		sfgaoMask: SFGAOF,
		psfgaoAttribs: ^SFGAOF,
	) -> HRESULT,
	Compare:            proc "stdcall" (
		this: ^IShellItem,
		psi: ^IShellItem,
		hint: SICHINTF,
		piOrder: ^c_int,
...
IShellItemArrayVtbl :: struct {
	...
	GetPropertyStore:           proc "stdcall" (
		this: ^IShellItemArray,
		flags: GETPROPERTYSTOREFLAGS,
		riid: REFIID,
		ppv: ^rawptr,
	) -> HRESULT,
	GetPropertyDescriptionList: proc "stdcall" (
		this: ^IShellItemArray,
	...
	GetCount:                   proc "stdcall" (
		this: ^IShellItemArray,
		pdwNumItems: ^DWORD,
	) -> HRESULT,
	GetItemAt:                  proc "stdcall" (
		this: ^IShellItemArray,
		dwIndex: DWORD,
		ppsi: ^^IShellItem,
	) -> HRESULT,
	EnumItems:                  proc "stdcall" (
		this: ^IShellItemArray,
...
IShellItemFilterVtbl :: struct {
	...
	GetEnumFlagsForItem: proc "stdcall" (
...
IFileDialogVtbl :: struct {
	...
	SetOptions:             proc "stdcall" (
		this: ^IFileDialog,
		fos: FILEOPENDIALOGOPTIONS,
	) -> HRESULT,
	GetOptions:             proc "stdcall" (
		this: ^IFileDialog,
	...
	AddPlace:               proc "stdcall" (
		this: ^IFileDialog,
		psi: ^IShellItem,
		fdap: FDAP,
	) -> HRESULT,
	SetDefaultExtension:    proc "stdcall" (
		this: ^IFileDialog,
...
IFileOpenDialogVtbl :: struct {
	...
	GetResults:            proc "stdcall" (
		this: ^IFileOpenDialog,
		ppenum: ^^IShellItemArray,
	) -> HRESULT,
	GetSelectedItems:      proc "stdcall" (
		this: ^IFileOpenDialog,
...
IPropertyStoreVtbl :: struct {
	...
	GetValue:           proc "stdcall" (
		this: ^IPropertyStore,
		key: REFPROPERTYKEY,
		pv: ^PROPVARIANT,
	) -> HRESULT,
	SetValue:           proc "stdcall" (
		this: ^IPropertyStore,
		key: REFPROPERTYKEY,
...
IFileOperationProgressSinkVtbl :: struct {
	...
	FinishOperations:   proc "stdcall" (
		this: ^IFileOperationProgressSink,
		hrResult: HRESULT,
	) -> HRESULT,
	PreRenameItem:      proc "stdcall" (
		this: ^IFileOperationProgressSink,
		dwFlags: DWORD,
		psiItem: ^IShellItem,
		pszNewName: LPCWSTR,
	) -> HRESULT,
	PostRenameItem:     proc "stdcall" (
		this: ^IFileOperationProgressSink,
		dwFlags: DWORD,
		psiItem: ^IShellItem,
		pszNewName: LPCWSTR,
	...
	PreDeleteItem:      proc "stdcall" (
		this: ^IFileOperationProgressSink,
		dwFlags: DWORD,
		psiItem: ^IShellItem,
	) -> HRESULT,
	PostDeleteItem:     proc "stdcall" (
		this: ^IFileOperationProgressSink,
		dwFlags: DWORD,
		psiItem: ^IShellItem,
		hrDelete: HRESULT,
	...
	PreNewItem:         proc "stdcall" (
		this: ^IFileOperationProgressSink,
		dwFlags: DWORD,
		psiDestinationFolder: ^IShellItem,
		pszNewName: LPCWSTR,
	) -> HRESULT,
	PostNewItem:        proc "stdcall" (
		this: ^IFileOperationProgressSink,
		dwFlags: DWORD,
		psiDestinationFolder: ^IShellItem,
		pszNewName: LPCWSTR,
...
IFileSaveDialogVtbl :: struct {
	...
	SetProperties:          proc "stdcall" (
		this: ^IFileSaveDialog,
		pStore: ^IPropertyStore,
	) -> HRESULT,
	SetCollectedProperties: proc "stdcall" (
		this: ^IFileSaveDialog,
		pList: ^IPropertyDescriptionList,
		fAppendDefault: BOOL,
	) -> HRESULT,
	GetProperties:          proc "stdcall" (
		this: ^IFileSaveDialog,
		ppStore: ^^IPropertyStore,
	) -> HRESULT,
	ApplyProperties:        proc "stdcall" (
		this: ^IFileSaveDialog,
		psi: ^IShellItem,
		pStore: ^IPropertyStore,
		hwnd: HWND,
...
ITaskbarList2Vtbl :: struct {
	...
	MarkFullscreenWindow:   proc "stdcall" (
		this: ^ITaskbarList2,
		hwnd: HWND,
		fFullscreen: BOOL,
	) -> HRESULT,
...
ITaskbarList3Vtbl :: struct {
	...
	SetProgressValue:        proc "stdcall" (
		this: ^ITaskbarList3,
		hwnd: HWND,
		ullCompleted: ULONGLONG,
		ullTotal: ULONGLONG,
	) -> HRESULT,
	SetProgressState:        proc "stdcall" (
		this: ^ITaskbarList3,
		hwnd: HWND,
		tbpFlags: TBPFLAG,
	) -> HRESULT,
	RegisterTab:             proc "stdcall" (
		this: ^ITaskbarList3,
		hwndTab: HWND,
		hwndMDI: HWND,
	) -> HRESULT,
	UnregisterTab:           proc "stdcall" (this: ^ITaskbarList3, hwndTab: HWND) -> HRESULT,
	SetTabOrder:             proc "stdcall" (
		this: ^ITaskbarList3,
		hwndTab: HWND,
		hwndInsertBefore: HWND,
	) -> HRESULT,
	SetTabActive:            proc "stdcall" (
		this: ^ITaskbarList3,
		hwndTab: HWND,
		hwndMDI: HWND,
		dwReserved: DWORD,
	) -> HRESULT,
	ThumbBarAddButtons:      proc "stdcall" (
		this: ^ITaskbarList3,
		hwnd: HWND,
		cButtons: UINT,
		pButton: LPTHUMBBUTTON,
	) -> HRESULT,
	ThumbBarUpdateButtons:   proc "stdcall" (
		this: ^ITaskbarList3,
		hwnd: HWND,
		cButtons: UINT,
		pButton: LPTHUMBBUTTON,
	) -> HRESULT,
	ThumbBarSetImageList:    proc "stdcall" (
		this: ^ITaskbarList3,
		hwnd: HWND,
		himl: HIMAGELIST,
	) -> HRESULT,
	SetOverlayIcon:          proc "stdcall" (
		this: ^ITaskbarList3,
		hwnd: HWND,
		hIcon: HICON,
		pszDescription: LPCWSTR,
	) -> HRESULT,
	SetThumbnailTooltip:     proc "stdcall" (
		this: ^ITaskbarList3,
		hwnd: HWND,
		pszTip: LPCWSTR,
	) -> HRESULT,
	SetThumbnailClip:        proc "stdcall" (
		this: ^ITaskbarList3,
		hwnd: HWND,
		prcClip: ^RECT,
	) -> HRESULT,
