...
foreign ws2_32 {
	...
	WSADuplicateSocketW :: proc(s: SOCKET, dwProcessId: DWORD, lpProtocolInfo: LPWSAPROTOCOL_INFO) -> c_int ---
	// [MS-Docs](https://learn.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-wsasend)
	WSASend :: proc(s: SOCKET, lpBuffers: LPWSABUF, dwBufferCount: DWORD, lpNumberOfBytesSent: LPDWORD, dwFlags: DWORD, lpOverlapped: LPWSAOVERLAPPED, lpCompletionRoutine: LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> c_int ---
	// [MS-Docs](https://learn.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-wsarecv)
	WSARecv :: proc(s: SOCKET, lpBuffers: LPWSABUF, dwBufferCount: DWORD, lpNumberOfBytesRecvd: LPDWORD, lpFlags: LPDWORD, lpOverlapped: LPWSAOVERLAPPED, lpCompletionRoutine: LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> c_int ---
	// [MS-Docs](https://learn.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-wsasocketw)
	WSASocketW :: proc(af: c_int, kind: c_int, protocol: c_int, lpProtocolInfo: LPWSAPROTOCOL_INFO, g: GROUP, dwFlags: DWORD) -> SOCKET ---
	...
	socket :: proc(af: c_int, type: c_int, protocol: c_int) -> SOCKET ---
	...
	recvfrom :: proc(socket: SOCKET, buf: rawptr, len: c_int, flags: c_int, addr: ^SOCKADDR_STORAGE_LH, addrlen: ^c_int) -> c_int ---
	// [MS-Docs](https://learn.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-sendto)
	sendto :: proc(socket: SOCKET, buf: rawptr, len: c_int, flags: c_int, addr: ^SOCKADDR_STORAGE_LH, addrlen: c_int) -> c_int ---
	...
	setsockopt :: proc(s: SOCKET, level: c_int, optname: c_int, optval: rawptr, optlen: c_int) -> c_int ---
	...
	getaddrinfo :: proc(node: cstring, service: cstring, hints: ^ADDRINFOA, res: ^^ADDRINFOA) -> c_int ---
	...
	GetAddrInfoExW :: proc(pName: PCWSTR, pServiceName: PCWSTR, dwNameSpace: DWORD, lpNspId: LPGUID, hints: ^ADDRINFOEXW, ppResult: ^PADDRINFOEXW, timeout: ^timeval, lpOverlapped: LPOVERLAPPED, lpCompletionRoutine: LPLOOKUPSERVICE_COMPLETION_ROUTINE, lpHandle: LPHANDLE) -> INT ---
	// [MS-Docs](https://learn.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-select)
	select :: proc(nfds: c_int, readfds: ^fd_set, writefds: ^fd_set, exceptfds: ^fd_set, timeout: ^timeval) -> c_int ---
	// [MS-Docs](https://learn.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-getsockopt)
	getsockopt :: proc(s: SOCKET, level: c_int, optname: c_int, optval: ^c_char, optlen: ^c_int) -> c_int ---
