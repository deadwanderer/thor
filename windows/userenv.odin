...
foreign userenv {
	GetUserProfileDirectoryW :: proc(hToken: HANDLE, lpProfileDir: LPWSTR, lpcchSize: ^DWORD) -> BOOL ---
	...
	CreateProfile :: proc(pszUserSid: LPCWSTR, pszUserName: LPCWSTR, pszProfilePath: wstring, cchProfilePath: DWORD) -> u32 ---
	...
	DeleteProfileW :: proc(lpSidString: LPCWSTR, lpProfilePath: LPCWSTR, lpComputerName: LPCWSTR) -> BOOL ---
	...
	ConvertSidToStringSidW :: proc(Sid: ^SID, StringSid: ^LPCWSTR) -> BOOL ---
}
