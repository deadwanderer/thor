...
foreign kernel32 {
	...
	WriteConsoleA :: proc(hConsoleOutput: HANDLE, lpBuffer: LPCVOID, nNumberOfCharsToWrite: DWORD, lpNumberOfCharsWritten: LPDWORD, lpReserved: LPVOID) -> BOOL ---
	...
	GetProcessAffinityMask :: proc(hProcess: HANDLE, lpProcessAffinityMask: PDWORD_PTR, lpSystemAffinityMask: PDWORD_PTR) -> BOOL ---
	SetProcessAffinityMask :: proc(hProcess: HANDLE, dwProcessAffinityMask: DWORD_PTR) -> BOOL ---
	SetThreadAffinityMask :: proc(hThread: HANDLE, dwThreadAffinityMask: DWORD_PTR) -> DWORD_PTR ---
	...
	CopyFileW :: proc(lpExistingFileName: LPCWSTR, lpNewFileName: LPCWSTR, bFailIfExists: BOOL) -> BOOL ---
