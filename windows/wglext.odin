...
wglCreateBufferRegionARBType :: #type proc "c" (
	hDC: HDC,
	iLayerPlane: c_int,
	uType: UINT,
) -> HANDLE
wglDeleteBufferRegionARBType :: #type proc "c" (hRegion: HANDLE)
wglSaveBufferRegionARBType :: #type proc "c" (
	hRegion: HANDLE,
	x: c_int,
	y: c_int,
	width: c_int,
...
wglRestoreBufferRegionARBType :: #type proc "c" (
	hRegion: HANDLE,
	x: c_int,
	y: c_int,
	width: c_int,
...
wglCreatePbufferARBType :: #type proc "c" (
	hDC: HDC,
	iPixelFormat, iWidth, iHeight: c_int,
	piAttribList: [^]c_int,
) -> HPBUFFERARB
...
wglQueryPbufferARBType :: #type proc "c" (
...
wglGetPixelFormatAttribivARBType :: #type proc "c" (
	hdc: HDC,
	iPixelFormat, iLayerPlane: c_int,
	nAttributes: UINT,
	piAttributes: [^]c_int,
	piValues: [^]c_int,
) -> BOOL
wglGetPixelFormatAttribfvARBType :: #type proc "c" (
	hdc: HDC,
	iPixelFormat, iLayerPlane: c_int,
	nAttributes: UINT,
	piAttributes: [^]c_int,
